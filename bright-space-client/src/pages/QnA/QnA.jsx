        ...
        <div className="w-[70%] flex flex-col gap-8">
          <div className="bg-white border rounded-lg shadow-md p-6 ">
            ...
            <p className="text-gray-700 mb-4">
              I’m a 19-year-old student from Malaysia. I’ve been introduced to
              the language at a very young age and I’m capable of conducting any
              type of conversation. However, some of my English-speaking friends
              on the internet didn’t take too...
            </p>
            ...
            <div className="flex items-center justify-between bg-[#ebe9e9] rounded-md">
              ...
              <div className="flex items-center space-x-4 ml-5  bg-white px-3 py-2 rounded-md">
                ...
                <span className="text-xl font-bold  opacity-60">{upvotes}</span>
