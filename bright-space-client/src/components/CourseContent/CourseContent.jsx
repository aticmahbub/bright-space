...
const CourseContent = () => {
  ...
  return (
    <Box mt={"70px"}>
      ...
      <Box border={"0.5px solid #376bf1"}  borderRadius={"lg"} overflow={"hidden"} bg={"white"}>
        <Box
          display="flex"
          alignItems="center"
        ...
        >
          <Text fontSize={"xl"}>Advanced Concepts</Text>
          <Icon
            fontSize={"2xl"}
            as={
              advancedContent
        ...
        {/* {advancedContent && ( */}
          <>
            <Box className="space-y-4" display={ advancedContent ? "" : "none"} >
              ...
              <Box _hover={{bg:"gray.100"}} display={"flex"} justifyContent={"space-between"} px={"4"} py={"2"}>
