...
const Banner = () => {
    return (
        <Box display='flex' flexDir='column' alignItems='center' justifyContent='center' gap='5' maxW='1596px' mx='auto' px='2' py={{ base: 10, md: 20, lg: 0 }} className='lg:h-[calc(100vh-141px)]' textAlign='center' textColor='#1A1A1A'>
            <Box pos='relative' display='flex' alignItems='center' justifyContent='center' gap='10px' px={{ base: 3, '2xl': 5 }} py={{ base: 3, '2xl': '14px' }} border='1px' borderColor='#F1F1F3' rounded='lg' bg='#FCFCFD'>
                <Image src={sparkLine} alt='spark icon' w={{ base: 7, md: 8, lg: 10 }} pos='absolute' left={{ base: -2, md: -6, lg: -7 }} top={{ base: -2, md: -6, lg: -7 }} />
                <Box bg='#FFF4E5' p={{ base: 3, '2xl': 4 }} rounded='md'>
            ...
            <Box>
                ...
                <ButtonGroup gap='2' mt={{ base: 8, md: 16 }}>
                    <Button colorScheme='primary' size={{ base: 'sm', md: 'lg' }}>Explore Courses</Button>
                    <Button colorScheme='primary' size={{ base: 'sm', md: 'lg' }} variant='outline'>View Pricing</Button>
                </ButtonGroup>
            </Box>
        </Box>
    );
