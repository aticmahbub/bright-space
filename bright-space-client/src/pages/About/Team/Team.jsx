import img1 from '../../../assets/about/cards/atic.png'
  ...
  return (
    <div className="max-w-7xl mx-auto mb-10">
      ...
      <div className="flex justify-center items-center gap-5  my-10">
        <p className="border p-5 bg-gray-300">
          <svg
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  lg:gap-10">
        {/* cards */}
        {
          ...
          <div 
          className="h-1 w-40 bg-black mx-auto rounded"></div>
          <div className="flex flex-col justify-center p-5 shadow-md rounded-xl bg-white text-black">
